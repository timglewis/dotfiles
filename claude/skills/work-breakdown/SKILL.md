...
type definitions and the rule for choosing between them, so follow it rather than deciding here.**
...
| --- | --- | --- | --- |
| 1 | Technical Story | Add PaymentStatus to the domain model | none |
...
the items here, just explain the logic.
